...
DEMO_CASES = [
    ...
    # ── PASS: Domestic PEP, routine mortgage payment ──
    {
        "id": "domestic-pep-routine",
        "name": "Domestic PEP - Mortgage (PASS)",
        "description": "Provincial PEP making routine mortgage payment. Long relationship, fully documented.",
        "category": "PASS",
        "expected_outcome": "pass",
