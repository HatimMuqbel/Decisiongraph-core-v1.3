...
| Field | Value |
|-------|-------|
| Decision ID | `61004d2075c8e3ca...` |
| Case ID | `TEST-E-01` |
| Timestamp | `2026-02-13T04:39:12.186501` |
| Jurisdiction | CA |
...
Governance correction applied: STR determination removed due to insufficient Tier 1 evidence. Case cleared — no reporting obligation.
...
>
> Original verdict: `STR` → Classifier outcome: `NO_REPORT`
...
1. **[REQUIRED]** Document rationale for no-action determination
2. **[STANDARD]** Next scheduled review: 6 months (elevated risk factors present)
3. **[STANDARD]** File retention: per PCMLTFA s. 6
...
**Engine** determined `STR_REQUIRED` — **Governed** overrode to `NO_REPORT`
...
**Engine** determined `STR_REQUIRED` — **Classification** overrode to `NO_REPORT`

> Engine produced STR_REQUIRED from rules/gates. Classifier independently determined NO_REPORT from suspicion indicators.
...
> **Resolution:** Gate 1 (Typology Maturity), Gate 1 (Typology Maturity), Gate 1 (Typology Maturity), Gate 1 (Typology Maturity) blocked escalation — If indicators fail corroboration -> escalation prohibited. Engine followed gate logic.
...
| Typology Maturity Assessment | FAIL | Escalation prohibited by policy (Typology Maturity not met). |
| Mitigation Override Check | FAIL | Mitigations insufficient to explain behavior. |
| Suspicion Definition Test | FAIL | If NONE apply -> escalation is forbidden. |
...
| Mitigation Failure Analysis | PASS | Hard stop present. Mitigations do not apply to legal prohibitions. |
| Typology Confirmation | PASS | Typology is supporting, not required. STRs may exist without a named typology. |
| Regulatory Reasonableness | PASS | Hard stop mandates regulatory reporting. |


### Gate Override Analysis

**Gate 1: Zero-False-Escalation Check**

| | |
|---|---|
| Gate Result | `PERMITTED` |
| Final Disposition | **NO_REPORT** |
| Override Mechanism | Governance correction — false escalation prevention |
| Authority | PCMLTFA s. 7 — STR requires Tier 1 suspicion, not risk alone |

**Override Basis:**

- 0 Tier 1 suspicion indicators — escalation not justified
...
|-----------|--------|--------|
| `HARD_STOP_CHECK` | TRIGGERED | SANCTIONS_MATCH |
...
| Neutral | 0 |
| **Total Decisive** | **0** |
| Typical Outcome for Cluster | NO_REPORT |
...
| Field | Value |
|-------|-------|
| Hard stop | SANCTIONS_MATCH |
| SAN_001 | Uncorroborated |
| Typology | Typology indicators (NONE) [primary/NONE] |
...
| `facts.sanctions_result` | Sanctions screening determination | MATCH |
...
| `typology.maturity` | Typology assessment maturity level | NONE |
...
*Actions available for governed disposition: **NO_REPORT***
...
| Field | Value |
|-------|-------|
| Case Created | `2026-02-13T04:39:12.186351Z` |
| EDD Deadline | `N/A` |
...
| Field | Value |
|-------|-------|
| Decision Hash | `61004d2075c8e3cab3ce0a57c9150c1e62b6b15161028daa482a7778eb7f1709` |
| Input Hash | `74cec14c340f9005b50be41f2cca4fd9a059760a0f767fab512b1ccb52e20246` |
...
*Generated 2026-02-13T04:39:12.186501*
